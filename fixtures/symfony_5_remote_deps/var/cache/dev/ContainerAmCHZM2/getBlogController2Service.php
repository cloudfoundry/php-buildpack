...
class getBlogController2Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.5Hwg15L'] ?? $container->load('get_ServiceLocator_5Hwg15LService'))->withContext('App\\Controller\\BlogController', $container));
