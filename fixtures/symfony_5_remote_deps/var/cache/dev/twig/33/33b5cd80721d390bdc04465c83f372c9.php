...
class __TwigTemplate_fff4edfda9c9060ba8012fa900d02f36 extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/php-buildpack/fixtures/symfony_5_remote_deps/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}
