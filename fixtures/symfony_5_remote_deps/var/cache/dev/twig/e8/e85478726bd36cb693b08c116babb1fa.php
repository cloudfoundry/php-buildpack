...
class __TwigTemplate_159751e95f9550261047e8fbd70a80e9 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 118, $this->source); })()), "query", [], "any", false, false, false, 118), "get", ["connection"], "method", false, false, false, 118), "query" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,             // line 119
    ...
    ";
        ...
        <div class=\"metrics\">
            ...
            <div class=\"metric\">
                <span class=\"value\">";
            // line 166
            echo twig_escape_filter($this->env, twig_sprintf("%0.2f", (twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 166, $this->source); })()), "time", [], "any", false, false, false, 166) * 1000)), "html", null, true);
            echo " ms</span>
        ...
        ";
                ...
                foreach ($context['_seq'] as $context["i"] => $context["query"]) {
                    ...
                    if ((isset($context["group_queries"]) || array_key_exists("group_queries", $context) ? $context["group_queries"] : (function () { throw new RuntimeError('Variable "group_queries" does not exist.', 231, $this->source); })())) {
                        ...
                        // line 233
                        echo twig_escape_filter($this->env, twig_sprintf("%0.2f", twig_get_attribute($this->env, $this->source, $context["query"], "executionPercent", [], "any", false, false, false, 233)), "html", null, true);
                        echo "%\"></span>
                                    <span class=\"nowrap\">";
                        // line 234
                        echo twig_escape_filter($this->env, twig_sprintf("%0.2f", (twig_get_attribute($this->env, $this->source, $context["query"], "executionMS", [], "any", false, false, false, 234) * 1000)), "html", null, true);
                        echo "&nbsp;ms<br />(";
                        echo twig_escape_filter($this->env, twig_sprintf("%0.2f", twig_get_attribute($this->env, $this->source, $context["query"], "executionPercent", [], "any", false, false, false, 234)), "html", null, true);
                        echo "%)</span>
                                </td>
                                <td class=\"nowrap\">";
                        // line 236
                        ...
                        echo "</td>
                                <td class=\"nowrap\">";
                        // line 239
                        echo twig_escape_filter($this->env, twig_sprintf("%0.2f", (twig_get_attribute($this->env, $this->source, $context["query"], "executionMS", [], "any", false, false, false, 239) * 1000)), "html", null, true);
                        echo "&nbsp;ms</td>
                            ";
                    }
                    // line 241
...
{% endmacro %}
", "@Doctrine/Collector/db.html.twig", "/php-buildpack/fixtures/symfony_5_remote_deps/vendor/doctrine/doctrine-bundle/Resources/views/Collector/db.html.twig");
    }
}
