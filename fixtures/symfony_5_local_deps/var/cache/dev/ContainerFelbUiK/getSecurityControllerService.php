...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.GcpeMM3'] ?? $container->load('get_ServiceLocator_GcpeMM3Service'))->withContext('App\\Controller\\SecurityController', $container));
