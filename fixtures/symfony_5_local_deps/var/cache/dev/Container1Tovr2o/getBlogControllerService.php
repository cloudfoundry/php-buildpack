...
class getBlogControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.NR9bxsq'] ?? $container->load('get_ServiceLocator_NR9bxsqService'))->withContext('App\\Controller\\Admin\\BlogController', $container));
