...
class TestNewRelic(object):
    ...
    def testDefaults(self):
        ...
        eq_(True, 'APPDYNAMICS_HOST' in nr._ctx.keys())
        eq_(True, 'APPDYNAMICS_VERSION' in nr._ctx.keys())
        eq_(True, 'APPDYNAMICS_PACKAGE' in nr._ctx.keys())
        eq_(True, 'APPDYNAMICS_DOWNLOAD_URL' in nr._ctx.keys())
        eq_(True, 'APPDYNAMICS_STRIP' in nr._ctx.keys())
