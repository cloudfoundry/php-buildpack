    ...
    def assert_files_installed(self, build_dir):
        ...
        (fah.expect()
            .root(build_dir, 'php')
                ...
                .path('sbin', 'php-fpm')
                .path('bin')
                .root(build_dir, 'php', 'lib', 'php', 'extensions','no-debug-non-zts-20210902') # this should match defaults/config/php/<DEFAULT VERSION>/php.ini extensions_dir value
                .path('bz2.so')
                .path('zlib.so')
                .path('curl.so')
            .exists())
    ...
    def assert_files_installed(self, build_dir):
        ...
        (fah.expect()
            ...
            .root(build_dir, 'php', 'lib', 'php', 'extensions',
                  'no-debug-non-zts-20210902') # this should match defaults/config/php/<DEFAULT VERSION>/php.ini extensions_dir value
                .path('bz2.so')
                .path('zlib.so')
                .path('curl.so')
            .exists())
