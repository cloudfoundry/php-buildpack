...
class CompileExtensions(object):
    ...
    def default_version_for(self, manifest_file, dependency):
        exit_code, default_version = self.call_compile_extensions_script('default_version_for', manifest_file, dependency)
