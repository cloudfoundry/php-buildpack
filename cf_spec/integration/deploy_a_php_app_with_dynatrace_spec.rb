...
describe 'CF PHP Buildpack' do
  context '' do
    ...
    before(:all) do
      ...
      Machete::SystemHelper.run_cmd(%(cf cups dynatrace-test-service -p '{"apitoken":"","apiurl":"https://s3.amazonaws.com/dt-paas","environmentid":"envid"}'))
      Machete::SystemHelper.run_cmd(%(cf bind-service #{@app_name} dynatrace-test-service))
