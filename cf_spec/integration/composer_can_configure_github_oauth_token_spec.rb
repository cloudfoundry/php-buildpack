...
describe 'Composer' do
  ...
  context 'deploying an app with valid $COMPOSER_GITHUB_OAUTH_TOKEN variable set', if: Machete::BuildpackMode.online? do
  ...
  context 'deploying an app with an invalid $COMPOSER_GITHUB_OAUTH_TOKEN', if: Machete::BuildpackMode.online? do
